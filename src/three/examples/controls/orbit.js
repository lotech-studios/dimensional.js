...
class OrbitControls extends EventDispatcher {
	...
	setObjectOffset ( object, x, y, z ) {

		object.position.set( this.target.x + x, this.target.y + y, this.target.z + z )

		if ( object.target ) object.target.position.copy( this.target )
